                        ...
                        <div class="row tm-banner-row tm-banner-row-header">
                            <div class="col-xs-12">
                                <div class="tm-banner-header">
                                    ...
                                    <img src="${ctxPath}/resources/img/dots-3.png" alt="Dots">
            ...
            <div class="tm-container-outer" id="tm-section-2">
                <section class="tm-slideshow-section">
                    <div class="tm-slideshow">
                        <img src="${ctxPath}/resources/img/tm-img-01.jpg" alt="Image">
                        <img src="${ctxPath}/resources/img/tm-img-02.jpg" alt="Image">
                        <img src="${ctxPath}/resources/img/tm-img-03.jpg" alt="Image">    
                    </div>
                    ...
                    <div class="tab-pane fade" id="1a">
                        <div class="tm-recommended-place-wrap">
                            <div class="tm-recommended-place">
                                <img src="${ctxPath}/resources/img/tm-img-06.jpg" alt="Image" class="img-fluid tm-recommended-img">
                            ...
                            <div class="tm-recommended-place">
                                <img src="${ctxPath}/resources/img/tm-img-07.jpg" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
                            ...
                            <div class="tm-recommended-place">
                                <img src="${ctxPath}/resources/img/tm-img-05.jpg" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
                            ...
                            <div class="tm-recommended-place">
                                <img src="${ctxPath}/resources/img/tm-img-04.jpg" alt="Image" class="img-fluid tm-recommended-img">
                                <div class="tm-recommended-description-box">
